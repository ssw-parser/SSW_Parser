...
class Weapon:
    ...
    def __init__(self, key, art4, art5, apollo):
        ...
        self.range = WEAPONS[key][2]
        self.useammo = WEAPONS[key][5]
        ...
        if (WEAPONS[key][3] == "A"):
            if art5 == "TRUE":
                ...
                self.enhance = "A4"
        # Apollo
        elif (WEAPONS[key][3] == "P" and apollo == "TRUE"):
            self.enhance = "AP"
        # Tarcomp, we can not know if one is present right now
        elif (WEAPONS[key][3] == "T"):
            self.enhance = "TC"
