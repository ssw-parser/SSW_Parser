...
WEAPONS = {
    ...
    "(IS) Light Machine Gun" : [[5, 1], 1,
                                0,
                                "M", "", 3068, 1, 0.5, 0],
    "(IS) MG Array (2 Light Machine Gun)" : [[16.7, 1], 1,
                                             0,
                                             "M", "", 3068, 2, 1.5, 0],
    "(IS) MG Array (3 Light Machine Gun)" : [[25.05, 1], 1,
                                             0,
                                             "M", "", 3068, 3, 2, 0],
    "(IS) MG Array (4 Light Machine Gun)" : [[33.4, 1], 1,
                                             0,
                                             "M", "", 3068, 4, 2.5, 0],
    "(IS) Machine Gun" : [[5, 1], 0,
                          ...
                          "S", "", 1900, 1, 0.5, 0],
    # MG 2
    "(IS) MG Array (3 Machine Gun)" : [[25.05, 1], 1,
                                       0,
                                       "S", "", 3068, 3, 2, 0],
    "(IS) MG Array (4 Machine Gun)" : [[33.4, 1], 1,
                                       0,
                                       "S", "", 3068, 4, 2.5, 0],
    # HMG
    # HMG 2
    "(IS) MG Array (3 Heavy Machine Gun)" : [[30.06, 1], 1,
                                             0,
                                             "S", "", 3068, 3, 3.5, 0],
    # HMG 4
    "(IS) Flamer" : [[6, 0], 0,
    ...
    "(CL) Light Machine Gun" : [[5, 1], 1,
                                ...
                                "M", "", 3060, 1, 0.25, 0],
    # LMG 2
    "(CL) MG Array (3 Light Machine Gun)" : [[25.05, 1], 1,
                                             0,
                                             "M", "", 3069, 3, 1, 0],
    # LMG 4
    ...
    # MG 2
    # MG 3
    "(CL) MG Array (4 Machine Gun)" : [[33.4, 1], 1,
                                       0,
                                       "S", "", 3069, 4, 1.25, 0],
    "(CL) Heavy Machine Gun" : [[6, 1], 1,
                                ...
                                "S", "", 3059, 1, 0.5, 0],
    # HMG 2
    "(CL) MG Array (3 Heavy Machine Gun)" : [[30.06, 1], 1,
                                             0,
                                             "S", "", 3069, 3, 1.75, 0],
    "(CL) MG Array (4 Heavy Machine Gun)" : [[40.08, 1], 1,
                                             0,
                                             "S", "", 3069, 4, 2.25, 0],
    "(CL) Flamer" : [[6, 0], 1,
                     3,
    ...
    "(CL) Improved Heavy Medium Laser" : [[93, 0], 2,
                                          ...
                                          "M", "T", 3069, 0, 1, 2],
    # iHLL
    "(IS) Small Variable Speed Pulse Laser" : [[22, 0], 2,
                                               3,
                                               "M", "T", 3070, 0, 2, 0],
    "(IS) Medium Variable Speed Pulse Laser" : [[56, 0], 2,
                                                7,
                                                "M", "T", 3070, 0, 4, 0],
    "(IS) Large Variable Speed Pulse Laser" : [[123, 0], 2,
                                               10,
                                               "M", "T", 3070, 0, 9, 0],
    ...
    "(IS) Light PPC + PPC Capacitor" : [[132, 0], 2,
                                        10,
                                        "L", "T", 3067, 0, 4, 3],
    "(IS) Snub-Nose PPC + PPC Capacitor" : [[252, 0], 2,
                                            15,
                                            "M", "T", 3067, 0, 7, 3],
    # rest of +PPC cap
...
class Weapon:
    ...
    def __init__(self, key, art4, art5, apollo):
        ...
        self.range = WEAPONS[key][3]
        self.useammo = WEAPONS[key][6]
        self.explosive = WEAPONS[key][8]
        self.count = 0
        self.countrear = 0
        ...
        if (WEAPONS[key][4] == "A"):
            if art5 == "TRUE":
                ...
                self.enhance = "A4"
        # Apollo
        elif (WEAPONS[key][4] == "P" and apollo == "TRUE"):
            self.enhance = "AP"
        # Tarcomp, we can not know if one is present right now
        elif (WEAPONS[key][4] == "T"):
            self.enhance = "TC"
