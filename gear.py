...
weapons = [["(IS) Autocannon/2", 37, "L", "T", 2300, 1, 6, 1],
           ...
           ["(IS) Light PPC + PPC Capacitor", 132, "L", "T", 3067, 0, 4, 10],
           ...
           # Advanced Weapons
           ["(IS) Magshot Gauss Rifle", 15, "M", "T", 3072, 1, 0.5, 1],
           ["(IS) Small Variable Speed Pulse Laser", 22, "M", "T", 3070, 0, 2, 3],
           ["(IS) Medium Variable Speed Pulse Laser", 56, "M", "T", 3070, 0, 4, 7],
           ["(IS) Large Variable Speed Pulse Laser", 123, "M", "T", 3070, 0, 9, 10],
           ...
           ["(CL) Mech Mortar 8", 114, "L", "", 2840, 1, 5, 10],
           # Artillery
